...
convert.for.lstm <- function(t.coin, rvrp.length) {
  ...
  # MAJOR ERROR! Can't line up t.coin$gg[idx,] against rvrp[idx]. t.coin$gg has already been trimmed to gg. Oh no, does this data work at all or were we accidentally encoding the future...?
